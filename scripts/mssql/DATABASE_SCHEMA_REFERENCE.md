...
| `004-audit-logging.sql` | Audit logs and activity tracking |
...
Scripts must be executed in numeric order:
...
4. `004-audit-logging.sql` - Creates audit tables (depends on 001)
