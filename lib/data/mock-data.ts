...
export const MOCK_CONTRACTS: Contract[] = [
  {
    ...
    requestingEntityId: 'ENT-MOF-001',
    entityNumber: 'MDA-003',
    // Renewal/Supplemental tracking
    renewalCount: 0,
    supplementalCount: 0,
    maxRenewals: 3,
    hasPendingRenewal: false,
    hasPendingSupplemental: false,
    // Additional details for prepopulation
    ministry: 'Ministry of Finance',
    department: 'Treasury Department',
    contractNature: 'consultancy',
    contractCategory: 'CAT_CONS',
    contractInstrument: 'CONS_CO',
    currency: 'USD',
    fundingSource: 'budget',
    procurementMethod: 'selective-tender',
    contractStartDate: '2024-04-01',
    contractEndDate: '2025-03-31',
    duration: '12 months',
    scopeOfWork: 'Provide financial advisory services for government debt restructuring',
    contractorType: 'company',
    counterpartyCity: 'New York',
    counterpartyCountry: 'United States',
    companyRegistrationNumber: 'NY-12345678',
    taxIdentificationNumber: 'US-98-7654321',
    status: 'ACTIVE'
  },
  {
